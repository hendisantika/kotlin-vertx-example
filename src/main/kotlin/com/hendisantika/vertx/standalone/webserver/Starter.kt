...
fun main(args: Array<String>) {
    ...
    opt.instances = 2
    deploy("com.hendisantika.vertx.standalone.webserver.verticles.ServiceVerticle")
    deploy("com.hendisantika.vertx.standalone.webserver.verticles.WebVerticle", opt)
